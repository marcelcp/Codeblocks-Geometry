...
int main( void )
{
    ...
    window = glfwCreateWindow( SCREEN_WIDTH, SCREEN_HEIGHT, "Shapes", NULL, NULL );
    ...
    GLfloat pointVertex[] = { SCREEN_WIDTH / 10, SCREEN_HEIGHT*3 / 5 };
    ...
    while ( !glfwWindowShouldClose( window ) )
    {
        ...
        glPointSize( 7 ); // must be added before glDrawArrays is called
        ...
        drawTriangleCircle(SCREEN_WIDTH*3 / 4, SCREEN_HEIGHT / 4, 0, 80, 8);
