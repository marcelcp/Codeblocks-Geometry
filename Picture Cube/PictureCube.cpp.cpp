...
void init(void)
{
   ...
   tgaLoad  ( "picture.tga", &temp_image, TGA_FREE | TGA_LOW_QUALITY );
...
int main ( int argc, char** argv )   // Create Main Function For Bringing It All Together
{
  ...
  glutCreateWindow    ( "NeHe Lesson 6- Ported by Marcel Cahya Prasetia" ); // Window Title (argv[0] for current directory as title)
  init ();
